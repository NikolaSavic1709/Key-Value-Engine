...
//func main() {
//	key1 := "key14"
//	value1 := []byte("information001")
//	record1 := record.CreateRecord(key1, value1, 0)
//
//	key2 := "key07"
//	value2 := []byte("information002")
//	record2 := record.CreateRecord(key2, value2, 0)
//
//	key3 := "key02"
//	value3 := []byte("information004")
//	record3 := record.CreateRecord(key3, value3, 0)
//
//	key4 := "key22"
//	value4 := []byte("information010")
//	record4 := record.CreateRecord(key4, value4, 0)
//
//	key5 := "key39"
//	value5 := []byte("information100")
//	record5 := record.CreateRecord(key5, value5, 0)
//
//	records := make([]record.Record, 0)
//	records = append(records, *record3, *record2, *record1, *record4, *record5)
//
//	FormSSTable(records, 1, 1)
//
//	dataFilePath := "data/data/usertable-lvl=1-gen=1-Data.db"
//	indexFilePath := "data/index/usertable-lvl=1-gen=1-Index.db"
//	summaryFilePath := "data/summary/usertable-lvl=1-gen=1-Summary.db"
//
//	file, _ := os.Open(dataFilePath)
//	reader := bufio.NewReader(file)
//
//	PrintDataFile(reader)
//
//	file, _ = os.Open(indexFilePath)
//	reader = bufio.NewReader(file)
//
//	PrintIndexFile(reader)
//
//	file, _ = os.Open(summaryFilePath)
//	reader = bufio.NewReader(file)
//
//	PrintSummaryFile(reader)
//
//	foundRecord, found := GetRecordInSStableForKey("key07", summaryFilePath, indexFilePath, dataFilePath)
//	if found {
//		fmt.Println("Value:", string(foundRecord.Value))
//	} else {
//		fmt.Println("Nije pronadjen")
//	}
//}
